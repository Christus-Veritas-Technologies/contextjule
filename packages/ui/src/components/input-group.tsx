...
import { Textarea } from "@contextjule/ui/components/textarea";
...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
 ...
 role="group"
 className={cn(
 "group/input-group relative flex h-8 w-full min-w-0 items-center border border-input bg-background shadow-xs transition-[color,box-shadow] outline-none has-[>textarea]:h-auto dark:bg-input/30",
...
const inputGroupAddonVariants = cva(
 "flex h-auto cursor-text select-none items-center justify-center gap-2 py-1.5 text-xs font-medium text-muted-foreground group-data-[disabled=true]/input-group:opacity-50 [&>kbd]: [&>svg:not([class*='size-'])]:size-4",
 {
 variants: {
 align: {
